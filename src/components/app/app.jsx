...
function App(props) {
	...
	useEffect(() => {
		setShowNavbar(!(window.location.pathname === '/' || window.location.pathname.includes('sign-up') || window.location.pathname.includes('sign-in')));
	}, [props]);
	...
	return (
		<div>
			...
			<Switch>
				...
				<Route path="/create-obituary" component={CreateObituaryScreen} exact />
