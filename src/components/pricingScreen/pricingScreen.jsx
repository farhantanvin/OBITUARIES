		...
		return (
			<div className={Styles.priceMainContainer}>
				...
				<div className={Styles.plansContainer}>
					<PricingComponent planName ={'Basic'} planPrice={'$50 USD'} planDetail1={'Static post on Facebook and Instragram'} planDetail2={'FB Boosting - 1 Day'} planDetail3={'Publication on Website'}>
						<BasicPrize className={Styles.icon}/>
					</PricingComponent>
					<PricingComponent planName ={'Plus'} planPrice={'$150 USD'} planDetail1={'Static post on Facebook and Instragram'} planDetail2={'FB Boosting - 1 Day'} planDetail3={'Publication on Website'}>
						<PlusPrize className={Styles.icon}/>
					</PricingComponent>
					<PricingComponent planName ={'Premium'} planPrice={'$250 USD'} planDetail1={'Static post on Facebook and Instragram'} planDetail2={'FB Boosting - 1 Day'} planDetail3={'Publication on Website'}>
